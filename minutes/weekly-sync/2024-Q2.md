...
* PRs for 3.5 release (e.g.hit testing support for wheel zoom, resizing drag handles for box annotation). RC hopefully by the end of this week.
* PR about fixing a regression with BokehJS API
