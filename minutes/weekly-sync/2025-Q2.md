...
* Finished work on hit filtering
* Working on sizebar and related tasks
* Push forward the reconnect PR (from external contributor)
* Cleaning up icons css - removing pngs, some inconsistent line widths, will open an issue

#### CZI R6

* Gabriel
    * Continuing slowly on [CSV/JSON export functionality](https://github.com/bokeh/bokeh/issues/14506). I have been looking through the codebase, how serialization is done between Python and JavaScript, etc.

* Pavithra - no new updates, WIP from last week
...
* Gabriel - Added a [wiki page on personal dev setup](https://github.com/bokeh/bokeh/wiki/Gabriel's-BokehJS-dev-setup)
* Discuss 3.8 next week
