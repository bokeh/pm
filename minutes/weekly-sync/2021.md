...
- tentative fix for data randing with circles (PR #11705)
...
- [ ] (Philipp) discussions about RC lead time and feature freezes
- [ ] (Bryan) open discussion about `branch-2.5`
- [ ] (Bryan) create issue for downstream maintainer guidance
